...
class MyApp {
    ...
    private pages: Array<any> = [DashBoardPage, SpendingPage, ListTypeSpendingPage, ListWalletPage, SharePage];
    ...
    constructor(private platform: Platform, private dataProviderService: DataProviderService, private events: Events, private menuController: MenuController) {
        ...
        platform.ready().then(() => {
            ...
            // Facebook.browserInit(1747907265472580, 'v2.7').then(res => {
            //     console.log('FB init', res);
            // }).catch(e=>{
